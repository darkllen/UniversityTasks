...
public class Dislin {
  ...
  public static native void concrv (float [] xray, float [] yray, int n,
                                    float zlev);
  public static native void concrv (double [] xray, double [] yray, int n,
                                    float zlev);
  ...
  public static native void conshd2 (float [] xmat, float [] ymat,
                             float [] zmat, int n, int m, 
                             float [] zlev, int nlev);
  public static native void conshd2 (double [] xmat, double [] ymat,
                             double [] zmat, int n, int m, 
  ...
  public static native void contur2 (float [] xmat, float [] ymat, 
                             float [] zmat, int n, int m, float zlev);
  public static native void contur2 (double [] xmat, double [] ymat, 
                             double [] zmat, int n, int m, float zlev);
  ...
  public static native int  csrpol (int [] ixray, int [] iyray, int nmax);
  ...
  public static native void fitscls ();
  public static native float fitsflt (String s);
  public static native int  fitshdu (int n);
  public static native int  fitsimg (byte [] iray, int nmax); 
  public static native int  fitsopn (String cfil);
  public static native String fitsstr (String s);
  public static native int  fitstyp (String s);
  public static native int  fitsval (String s);
  ...
  public static native void getico (float x, float y, float [] xray);
  ...
  public static native void getrco (float x, float y, float [] xray);
  ...
  public static native void grafr  (float [] xray, int n, 
                                    float [] yray, int m);
  public static native void grafr  (double [] xray, int n, 
                                    double [] yray, int m);
  public static native void grffin ();
  public static native void grfimg (String cfil);
  ...
  public static native void gridim (float x1, float x2, float x3, int n);
  public static native void gridmp (int ixgrid, int iygrid);
  public static native void gridre (float x1, float x2, float x3, int n);
  ...
  public static native void linfit (float [] xray, float [] yray, int n,
                                    float [] xout, String copt);
  public static native void linfit (double [] xray, double [] yray, int n,
                                    double [] xout, String copt);
  ...
  public static native int  polclp (float [] xray, float [] yray, int n, 
                                    float [] xout, float [] yout, int nmax, 
                                    float xv, String cedge);
  public static native int  polclp (double [] xray, double [] yray, int n, 
                                    double [] xout, double [] yout, int nmax,
                                    float xv, String cedge);
  ...
  public static native void trfco3 (float [] xray, float [] yray, 
                                    float [] zray, int n, String cfrom, 
                                    String cto); 
  public static native void trfco3 (double [] xray, double [] yray, 
                                    double [] zray, int n, String cfrom,
                                    String cto); 

...
JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_conshd2___3D_3D_3DII_3DI
       (JNIEnv *env, jobject object, 
        jdoubleArray arr1, jdoubleArray arr2, jdoubleArray arr3, 
        jint n, jint m, jdoubleArray arr4, jint nlev)
{ jdouble *xmat = (*env)->GetDoubleArrayElements(env, arr1, 0);
  jdouble *ymat = (*env)->GetDoubleArrayElements(env, arr2, 0);
  jdouble *zmat = (*env)->GetDoubleArrayElements(env, arr3, 0);
  jdouble *zlev = (*env)->GetDoubleArrayElements(env, arr4, 0);
  conshd2 ((double *) xmat, (double *) ymat, (double *) zmat, n, m, 
          (double *) zlev, nlev);
  (*env)->ReleaseDoubleArrayElements(env, arr1, xmat, 0);
  (*env)->ReleaseDoubleArrayElements(env, arr2, ymat, 0);
  (*env)->ReleaseDoubleArrayElements(env, arr3, zmat, 0);
  (*env)->ReleaseDoubleArrayElements(env, arr4, zlev, 0);
}
...
JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_conshd2___3F_3F_3FII_3FI 
       (JNIEnv *env, jobject object, 
        jfloatArray arr1, jfloatArray arr2, jfloatArray arr3,
        jint n, jint m, jfloatArray arr4, jint nlev)
{ double *p1 = dbl_array (env, arr1, n * m);
  double *p2 = dbl_array (env, arr2, n * m);
  double *p3 = dbl_array (env, arr3, n * m);
  double *p4 = dbl_array (env, arr4, nlev);
  if (p1 != NULL && p2 != NULL && p3 != NULL && p4 != NULL)
...
JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_contur2___3D_3D_3DIIF (JNIEnv *env, jobject object, 
        jdoubleArray arr1, jdoubleArray arr2, jdoubleArray arr3, 
        jint n, jint m, jfloat zlev)
{ jdouble *xmat = (*env)->GetDoubleArrayElements(env, arr1, 0);
  jdouble *ymat = (*env)->GetDoubleArrayElements(env, arr2, 0);
  jdouble *zmat = (*env)->GetDoubleArrayElements(env, arr3, 0);
  contur2 ((double *) xmat, (double *) ymat, (double *) zmat, n, m, zlev);
  (*env)->ReleaseDoubleArrayElements(env, arr1, xmat, 0);
  (*env)->ReleaseDoubleArrayElements(env, arr2, ymat, 0);
  (*env)->ReleaseDoubleArrayElements(env, arr3, zmat, 0);
}
...
JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_contur2___3F_3F_3FIIF (JNIEnv *env, jobject object, 
        jfloatArray arr1, jfloatArray arr2, jfloatArray arr3, 
        jint n, jint m, jfloat zlev)
{ double *p1 = dbl_array (env, arr1, n * m);
  double *p2 = dbl_array (env, arr2, n * m);
...
JNIEXPORT jint JNICALL 
Java_de_dislin_Dislin_csrpol (JNIEnv *env, jobject object, jintArray arr1, 
        jintArray arr2, jint nmax)
{ int iret, n;
  jint *ixray = (*env)->GetIntArrayElements(env, arr1, 0);
  jint *iyray = (*env)->GetIntArrayElements(env, arr2, 0);
  csrpol ((int *) ixray, (int *) iyray, nmax, &n, &iret);
  (*env)->ReleaseIntArrayElements(env, arr1, ixray, 0);
  (*env)->ReleaseIntArrayElements(env, arr2, iyray, 0);
  return n;
}
...
JNIEXPORT void JNICALL
Java_de_dislin_Dislin_fitscls (JNIEnv *env, jobject object)
{ fitscls ();
}

JNIEXPORT jfloat JNICALL
Java_de_dislin_Dislin_fitsflt (JNIEnv *env, jobject object, jstring s)
{ jfloat x1;
  const char *str = (*env)->GetStringUTFChars(env, s, 0);
  x1 = fitsflt ((char *) str);
  (*env)->ReleaseStringUTFChars(env, s, str);
...
JNIEXPORT jint JNICALL
Java_de_dislin_Dislin_fitshdu (JNIEnv *env, jobject object, jint i)
{ return fitshdu (i);
}

JNIEXPORT jint JNICALL 
Java_de_dislin_Dislin_fitsimg (JNIEnv *env, jobject object,  
        jbyteArray arr1, jint nmax)
{ int iret;
  jbyte *iray = (*env)->GetByteArrayElements(env, arr1, 0);
  iret = fitsimg ((unsigned char * ) iray, nmax);
  (*env)->ReleaseByteArrayElements(env, arr1, iray, 0);
  return iret;
}

JNIEXPORT jint JNICALL
Java_de_dislin_Dislin_fitsopn (JNIEnv *env, jobject object, jstring s)
{ int i1;
  const char *str = (*env)->GetStringUTFChars(env, s, 0);
  i1 = fitsopn ((char *) str);
  (*env)->ReleaseStringUTFChars(env, s, str);
...
JNIEXPORT jstring JNICALL
Java_de_dislin_Dislin_fitsstr (JNIEnv *env, jobject object, jstring s)
{ char cstr[257];
  const char *str = (*env)->GetStringUTFChars(env, s, 0);
  fitsstr ((char *) str, cstr, 257);
  return (*env)->NewStringUTF(env, cstr);
}

JNIEXPORT jint JNICALL
Java_de_dislin_Dislin_fitstyp (JNIEnv *env, jobject object, jstring s)
{ int i1;
  const char *str = (*env)->GetStringUTFChars(env, s, 0);
  i1 = fitstyp ((char *) str);
  (*env)->ReleaseStringUTFChars(env, s, str);
...
JNIEXPORT jint JNICALL
Java_de_dislin_Dislin_fitsval (JNIEnv *env, jobject object, jstring s)
{ int i1;
  const char *str = (*env)->GetStringUTFChars(env, s, 0);
  i1 = fitsval ((char *) str);
  (*env)->ReleaseStringUTFChars(env, s, str);
...
JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_getico (JNIEnv *env, jobject object, jfloat x, jfloat y,
        jfloatArray arr1)
{ double xp, yp;
  jfloat *xray = (*env)->GetFloatArrayElements(env, arr1, 0);
  getico ((double) x, (double) y, &xp, &yp);
  xray[0] = (jfloat) xp;
  xray[1] = (jfloat) yp;
  (*env)->ReleaseFloatArrayElements(env, arr1, xray, 0);
}
...
JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_getrco (JNIEnv *env, jobject object, jfloat x, jfloat y,
        jfloatArray arr1)
{ double xp, yp;
  jfloat *xray = (*env)->GetFloatArrayElements(env, arr1, 0);
  getrco ((double) x, (double) y, &xp, &yp);
  xray[0] = (jfloat) xp;
  xray[1] = (jfloat) yp;
  (*env)->ReleaseFloatArrayElements(env, arr1, xray, 0);
}
...
JNIEXPORT void JNICALL
Java_de_dislin_Dislin_grfimg (JNIEnv *env, jobject object, jstring s)
{ const char *str = (*env)->GetStringUTFChars(env, s, 0);
  grfimg ((char *) str);
  (*env)->ReleaseStringUTFChars(env, s, str);
}
...
JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_gridim (JNIEnv *env, jobject object, jfloat x1, 
        jfloat x2, jfloat x3, jint n)
{ gridim (x1, x2, x3, n);
}
...
JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_gridre (JNIEnv *env, jobject object, jfloat x1, 
        jfloat x2, jfloat x3, jint n)
{ gridre (x1, x2, x3, n);
}
...
JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_linfit___3D_3DI_3FLjava_lang_String_2 (
        JNIEnv *env, jobject object, 
        jdoubleArray arr1, jdoubleArray arr2, jint n, jfloatArray arr3, 
	jstring s1)
{ double a, b, r;
  jdouble *xray = (*env)->GetDoubleArrayElements(env, arr1, 0);
  jdouble *yray = (*env)->GetDoubleArrayElements(env, arr2, 0);
  jfloat  *xout = (*env)->GetFloatArrayElements(env, arr3, 0);
  const char *str1 = (*env)->GetStringUTFChars(env, s1, 0);
  linfit ((double *) xray, (double *) yray, n, &a, &b, &r, str1);
  xout[0] = (float) a;
  xout[1] = (float) b;
  xout[2] = (float) r;
  (*env)->ReleaseStringUTFChars(env, s1, str1);
  (*env)->ReleaseDoubleArrayElements(env, arr1, xray, 0);
  (*env)->ReleaseDoubleArrayElements(env, arr2, yray, 0);
  (*env)->ReleaseFloatArrayElements(env, arr3, xout, 0);
}

JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_linfit___3F_3FI_3FLjava_lang_String_2 (
        JNIEnv *env, jobject object, 
        jfloatArray arr1, jfloatArray arr2, jint n, jfloatArray arr3, 
	jstring s1)
{ double a, b, r;
  double *p1 = dbl_array (env, arr1, n);
  double *p2 = dbl_array (env, arr2, n);
...
JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_grafr___3D_3DI (JNIEnv *env, jobject object, 
        jdoubleArray arr1, jint n, jdoubleArray arr2, jint m)
{ jdouble *xray = (*env)->GetDoubleArrayElements(env, arr1, 0);
  jdouble *yray = (*env)->GetDoubleArrayElements(env, arr2, 0);
  grafr ((double *) xray, n, (double *) yray, m);
  (*env)->ReleaseDoubleArrayElements(env, arr1, xray, 0);
  (*env)->ReleaseDoubleArrayElements(env, arr2, yray, 0);
}

JNIEXPORT void JNICALL 
Java_de_dislin_Dislin_grafr___3F_3FI (JNIEnv *env, jobject object, 
        jfloatArray arr1, jint n, jfloatArray arr2, jint m)
{ double *p1 = dbl_array (env, arr1, n);
  double *p2 = dbl_array (env, arr2, m);
  if (p1 != NULL && p2 != NULL)
...
{ jint *inray = (*env)->GetIntArrayElements(env, arr1, 0);
  ...
  jint *icray = (*env)->GetIntArrayElements(env, arr3, 0);
  long *p;
  int i;
...
Java_de_dislin_Dislin_triang___3F_3FI_3I_3I_3II
       (JNIEnv *env, jobject object, jfloatArray arr1, jfloatArray arr2, 
        jint n, jintArray arr3, jintArray arr4, jintArray arr5, jint nmax)
{ int ntri;
  double *p1 = dbl_array (env, arr1, n + 3);
  double *p2 = dbl_array (env, arr2, n + 3);
  jint *n1ray = (*env)->GetIntArrayElements(env, arr3, 0);
  jint *n2ray = (*env)->GetIntArrayElements(env, arr4, 0);
  jint *n3ray = (*env)->GetIntArrayElements(env, arr5, 0);
  if (p1 != NULL && p2 != NULL)
